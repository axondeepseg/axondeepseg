...
def axon_segmentation(
    ...
    merge_masks(
        Path(path_acquisitions_folders) / (Path(input_filenames[0]).stem + '_seg-axon-manual_pred.png'),
        Path(path_acquisitions_folders) / (Path(input_filenames[0]).stem + '_seg-myelin-manual_pred.png'), 
