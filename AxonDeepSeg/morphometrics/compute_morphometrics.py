...
def get_axon_morphometrics(im_axon, path_folder=None, im_myelin=None, pixel_size=None, circle_approx = True):
    ...
    :param circle_approx: Boolean: if axon is considered circle, set to True else if considered ellipse, set to False.
    ...
    for prop_axon in axon_objects:
        ...
        if im_myelin is not None:
            ...
            if label_axonmyelin:
                ...
                _res1 = evaluate_myelin_thickness_in_px(prop_axon, prop_axonmyelin, circle_approx)
...
def evaluate_myelin_thickness_in_px(axon_object, axonmyelin_object ,circle_approx):
    ...
    :param circle_approx (boolean): value indicating whether you want to consider the shape as circle or ellipse for diameter calculation. 
    ...
    the region.
    """
    attribute = "equivalent_diameter" if circle_approx else "minor_axis_length" 
