...
axonmyelin_suffix = Path(
    "_seg-axonmyelin.png"
)  # axon + myelin segmentation suffix file name
...
axonmyelin_index_suffix = Path(
    "_axonmyelin_index.png"
)  # Colored axonmyelin segmentation + the index image
unmyelinated_suffix = Path(
    "_seg-uaxon.png"
)  # unmyelinated axon segmentation suffix file name
unmyelinated_index_suffix = Path(
    "_uaxon_index.png"
)  # Colored unmyelinated axon segmentation + the index image
...
side_effect_suffixes = tuple(
    [
        ...
        for s in [
            ...
            myelin_suffix,
            index_suffix,
            axonmyelin_index_suffix,
            unmyelinated_suffix,
            unmyelinated_index_suffix,
            nnunet_suffix,
        ]
    ]
)
