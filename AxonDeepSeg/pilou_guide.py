...
filename = '/pilou_config_network.json'
...
network_size_of_convolutions_per_layer = [[5,3],[9,3],[5,3],[9,3]]#[[3 for k in range(network_convolution_per_layer[i])] for i in range(network_depth)]
network_features_per_convolution = [[[1,64],[64,64]],[[64,128],[128,128]],[[128,256],[256,256]],[[256,512],[512,512]]]#,[[256,512],[512,512]],[[512,1024],[1024,1024]],[[1024,2048],[2048,2048]]]
