...
class metrics():
    ...
    def load_models(self):
        for path in self.path_models:
            ...
            for ckpt_name, ckpt in stats_dict.items():
                ...
                for name_image, testing_stats in testing_stats_list.items():
