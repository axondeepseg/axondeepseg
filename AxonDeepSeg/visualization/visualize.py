...
def visualize_segmentation(path):
    ...
    image_init = imread(path_img, as_gray=False, pilmode="L")
    ...
    if "mask.png" in cur_dir_items:
        ...
        mask = preprocessing.binarize(
            imread(path_mask, as_gray=False, pilmode="L"), threshold=125
        )
    ...
    if "MyelinSeg.jpg" in cur_dir_items:
        ...
        myelin = preprocessing.binarize(
            imread(path_myelin, as_gray=False, pilmode="L"), threshold=125
        )
