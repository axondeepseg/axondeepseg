...
class TestCore(object):
    ...
    def teardown_class(cls):
        ...
        modelPath = os.path.join(projectPath, 'AxonDeepSeg/models/default_SEM_model_v1')
    ...
    def test_metrics_single_wrapper_runs_succesfully_and_stats_file_exists(self):
        ...
        metrics_single_wrapper(path_model_folder, path_images_folder, resampled_resolution, overlap_value=25,statistics_filename=self.statsFilename,create_statistics_file=True, verbosity_level=2)
    ...
    def test_metrics_classic_wrapper_runs_succesfully_and_stats_file_exists(self):
        ...
        path_images_folder = self.imagesPath
        resampled_resolution = 0.1
        metrics_classic_wrapper(path_model_folder, path_images_folder, resampled_resolution, overlap_value=25,statistics_filename=self.statsFilename,create_statistics_file=True, verbosity_level=2)
        assert os.path.exists(os.path.join(self.modelPath,self.statsFilename))
