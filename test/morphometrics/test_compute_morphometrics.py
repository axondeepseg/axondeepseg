...
class TestCore(object):
    def setup(self):
        ...
        pred_axon_path = self.test_folder_path / ('image' +  axon_suffix.name)
        self.pred_axon = imageio_imread(pred_axon_path, as_gray=True)
        pred_myelin_path = self.test_folder_path / ('image' + myelin_suffix.name)
    ...
    def test_draw_axon_diameter_creates_file_in_expected_location(self):
        ...
        path_prediction = self.test_folder_path / ('image' + axonmyelin_suffix.name)
