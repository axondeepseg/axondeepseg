...
If the current models available in AxonDeepSeg do not perform sufficiently well with your dataset or for your applications and you are interested in training a model for AxonDeepSeg for your specific dataset, please reach out to the AxonDeepSeg team `here <mailto:axondeepseg@googlegroups.com>`__ to schedule a video-call to discuss more.
